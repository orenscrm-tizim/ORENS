    ...
    if (id) {
      fetch(`/api/products/${id}`)
        ...
        .then(data => {
          ...
          const sku = data.skus && data.skus.length > 0 ? data.skus[0] : null;
          ...
          setFormData({
            ...
            skuId: sku ? sku.id : '',
            skuName: sku ? sku.name : data.name,
            barcode: sku && sku.barcode ? sku.barcode : '',
            sellPrice: sku ? sku.sellPrice.toString() : '',
            costPrice: sku ? sku.costPrice.toString() : '',
          });
    ...
    <div className="p-3 md:p-6 max-w-4xl mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Mahsulot va uning variantini o'zgartirish</p>
        </div>
      </div>
